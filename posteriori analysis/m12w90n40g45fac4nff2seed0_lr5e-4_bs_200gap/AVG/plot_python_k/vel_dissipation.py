...
figPath = os.path.join(figfilePath, "vel_dissipation")
if not os.path.exists(figPath):
    os.makedirs(figPath)
print("图片存放路径：", figPath)

#-------------------------------------------------------------读入数据，#comment去掉标识符所在行
#fDNS= np.loadtxt("./DNS/{}/avg/avg_DNS_{}case_dissipation.dat".format(DNS_path,case_number),dtype=float)
#
# FNO1= np.loadtxt("./FNO/{}/data/avg/avg_FNO_{}case_dissipation.dat".format(FNO1_path,case_number),dtype=float)
# FNO2= np.loadtxt("./FNO/{}/data/avg/avg_FNO_{}case_dissipation.dat".format(FNO2_path,case_number),dtype=float)
#FNO3= np.loadtxt("./FNO/{}/data/avg/avg_FNO_{}case_dissipation.dat".format(FNO3_path,case_number),dtype=float)

# PINO1= np.loadtxt("./PINO/{}/data/avg/avg_PINO_{}case_dissipation.dat".format(PINO1_path,case_number),dtype=float)
# PINO2= np.loadtxt("./PINO/{}/data/avg/avg_PINO_{}case_dissipation.dat".format(PINO2_path,case_number),dtype=float)
#PINO3= np.loadtxt("./PINO/{}/data/avg/avg_PINO_{}case_dissipation.dat".format(PINO3_path,case_number),dtype=float)
# PINO4= np.loadtxt("./PINO/{}/data/avg/avg_PINO_{}case_dissipation.dat".format(PINO4_path,case_number),dtype=float)
# PINO5= np.loadtxt("./PINO/{}/data/avg/avg_PINO_{}case_dissipation.dat".format(PINO5_path,case_number),dtype=float)
# PINO6= np.loadtxt("./PINO/{}/data/avg/avg_PINO_{}case_dissipation.dat".format(PINO6_path,case_number),dtype=float)
fDNS= np.loadtxt("../fDNS/avg_fDNS_{}case_dissipation.dat".format(case_number),dtype=float)
...
IUFNO_11ep= np.loadtxt("../IUFNO_11ep/avg_IUFNO_{}case_dissipation.dat".format(case_number),dtype=float)
IUFNO_40ep= np.loadtxt("../IUFNO_40ep/avg_IUFNO_{}case_dissipation.dat".format(case_number),dtype=float)
F_IUFNO_35ep= np.loadtxt("../F-IUFNO_35ep/avg_FIUFNO_{}case_dissipation.dat".format(case_number),dtype=float)
SRF_IUFNO_36ep= np.loadtxt("../SRF-IUFNO_36ep/avg_SRFIUFNO_{}case_dissipation.dat".format(case_number),dtype=float)
F_IUFNO_40ep= np.loadtxt("../F-IUFNO_40ep/avg_FIUFNO_{}case_dissipation.dat".format(case_number),dtype=float)
SRF_IUFNO_40ep= np.loadtxt("../SRF-IUFNO_40ep/avg_SRFIUFNO_{}case_dissipation.dat".format(case_number),dtype=float)
F_IFNO_40ep= np.loadtxt("../F-IFNO_40ep/avg_FIFNO_{}case_dissipation.dat".format(case_number),dtype=float)
...
#SRF_IFNO_coeff_40ep= np.loadtxt("../SRF-IFNO_coeff_40ep/avg_SRFIUFNO_{}case_dissipation.dat".format(case_number),dtype=float)
SRF_IFNO_40ep= np.loadtxt("../SRF-IFNO_40ep/avg_SRFIFNO_{}case_dissipation.dat".format(case_number),dtype=float)
IFNO_40ep= np.loadtxt("../IFNO_40ep/avg_IFNO_{}case_dissipation.dat".format(case_number),dtype=float)
#--------------------------
y_fDNS=fDNS[:,1]
...
ylabel = r"$\mathdefault{\bar{\varepsilon}}$"
xlimit = [0,period]                        #坐标显示范围
ylimit = [0.0,1.0]
...
gfile = "vel_dissipation.png"              #保存的文件名
...
ax.xaxis.set_minor_locator(mpl.ticker.MultipleLocator(10))  #次刻度  #主刻度格式
...
#plt.plot(x[::1], y_SRF_IUFNO_36ep[::1], label=legend[1], linewidth=lineWidth,markerfacecolor='blue',markeredgecolor='red', linestyle='-' , markersize=8, alpha=1.0, marker='o',zorder=0)
'''plt.plot(x[::1], y_SRF_IUFNO_36ep[::1], label=legend[1], linewidth=lineWidth,color='blue', linestyle='-' , markersize=8, alpha=1.0, marker='o',zorder=0)
plt.plot(x[::1], y_F_IUFNO_35ep[::1], label=legend[2], linewidth=lineWidth,color='green', linestyle='-' , markersize=8, alpha=1.0, marker='^',zorder=0)
plt.plot(x[::1], y_SRF_IUFNO_40ep[::1], label=legend[3], linewidth=lineWidth,color='purple', linestyle='-' , markersize=8, alpha=1.0, marker='*',zorder=0)
plt.plot(x[::1], y_F_IUFNO_40ep[::1], label=legend[4], linewidth=lineWidth,color='orange', linestyle='-' , markersize=8, alpha=1.0, marker='v',zorder=0)
plt.plot(x[::1], y_IUFNO_11ep[::1], label=legend[5], linewidth=lineWidth,color='PINK', linestyle='-' , markersize=8, alpha=1.0, marker='s',zorder=0)
plt.plot(x[::1], y_IUFNO_40ep[::1], label=legend[9], linewidth=lineWidth,color='yellow', linestyle='-' , markersize=8, alpha=1.0, marker='o',zorder=0)
plt.plot(x[::1], y_SRF_IFNO_40ep[::1], label=legend[6], linewidth=lineWidth,color='cyan', linestyle='-' , markersize=8, alpha=1.0, marker='^',zorder=0)
plt.plot(x[::1], y_SRF_IFNO_coeff_40ep[::1], label=legend[10], linewidth=lineWidth,color='gray', linestyle='-' , markersize=8, alpha=1.0, marker='*',zorder=0)
plt.plot(x[::1], y_F_IFNO_40ep[::1], label=legend[7], linewidth=lineWidth, color='olive', linestyle='-' , markersize=8, alpha=1.0, marker='v', zorder=0) 
plt.plot(x[::1], y_IFNO_40ep[::1], label=legend[8], linewidth=lineWidth, color='violet', linestyle='-' , markersize=8, alpha=1.0, marker='s', zorder=0) '''
...
plt.plot(x[::1], y_IUFNO_11ep[::1], label=legend[5], linewidth=lineWidth,color='PINK', linestyle=':' ,zorder=0)
...
plt.plot(x[::1], y_IFNO_40ep[::1], label=legend[8], linewidth=lineWidth, color='violet', linestyle='dashed' , zorder=0) 

lgd_loc  = (0.72,0.55)
lgd_font = {'family':"Times New Roman", 'size':fontSize*0.4}
