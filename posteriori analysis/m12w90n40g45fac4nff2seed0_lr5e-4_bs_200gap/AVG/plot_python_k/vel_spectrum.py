...
for idx, case_number in enumerate(case_number_list):
    ...
    IUFNO = np.loadtxt("../IUFNO_40ep_k=1,2/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IUFNO = np.loadtxt("../F-IUFNO_40ep_k=1,2/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IFNO = np.loadtxt("../F-IFNO_40ep_k=1,2/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    IFNO = np.loadtxt("../IFNO_40ep_k=1,2/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    DSM = np.loadtxt("../DSM/{}case/avg_DSM_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)

    IUFNO_m01 = np.loadtxt("../IUFNO_40ep_k=1,2_mag0.1/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m01 = np.loadtxt("../F-IUFNO_40ep_k=1,2_mag0.1/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m01 = np.loadtxt("../F-IFNO_40ep_k=1,2_mag0.1/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    IFNO_m01 = np.loadtxt("../IFNO_40ep_k=1,2_mag0.1/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    DSM_m01 = np.loadtxt("../DSM_mag0.1/{}case/avg_DSM_mag0.1_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)

    IUFNO_m05 = np.loadtxt("../IUFNO_40ep_k=1,2_mag0.5/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m05 = np.loadtxt("../F-IUFNO_40ep_k=1,2_mag0.5/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m05 = np.loadtxt("../F-IFNO_40ep_k=1,2_mag0.5/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    IFNO_m05 = np.loadtxt("../IFNO_40ep_k=1,2_mag0.5/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    DSM_m05 = np.loadtxt("../DSM_mag0.5/{}case/avg_DSM_mag0.5_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)

    IUFNO_m1 = np.loadtxt("../IUFNO_40ep_k=1,2_mag1/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m1 = np.loadtxt("../F-IUFNO_40ep_k=1,2_mag1/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m1 = np.loadtxt("../F-IFNO_40ep_k=1,2_mag1/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    IFNO_m1 = np.loadtxt("../IFNO_40ep_k=1,2_mag1/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    DSM_m1 = np.loadtxt("../DSM_mag1/{}case/avg_DSM_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    
    IUFNO_m2 = np.loadtxt("../IUFNO_40ep_k=1,2_mag2/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m2 = np.loadtxt("../F-IUFNO_40ep_k=1,2_mag2/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m2 = np.loadtxt("../F-IFNO_40ep_k=1,2_mag2/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    IFNO_m2 = np.loadtxt("../IFNO_40ep_k=1,2_mag2/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    DSM_m2 = np.loadtxt("../DSM_mag2/{}case/avg_DSM_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)    
    
    IUFNO_m10 = np.loadtxt("../IUFNO_40ep_k=1,2_mag10/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m10 = np.loadtxt("../F-IUFNO_40ep_k=1,2_mag10/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m10 = np.loadtxt("../F-IFNO_40ep_k=1,2_mag10/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    IFNO_m10 = np.loadtxt("../IFNO_40ep_k=1,2_mag10/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    DSM_m10 = np.loadtxt("../DSM_mag10/{}case/avg_DSM_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    
    IUFNO_m5 = np.loadtxt("../IUFNO_40ep_k=1,2_mag5/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m5 = np.loadtxt("../F-IUFNO_40ep_k=1,2_mag5/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m5 = np.loadtxt("../F-IFNO_40ep_k=1,2_mag5/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    IFNO_m5 = np.loadtxt("../IFNO_40ep_k=1,2_mag5/{}case/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
    DSM_m5 = np.loadtxt("../DSM_mag5/{}case/avg_DSM_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)    
    ...
    for i in range(len(time_advance)):
        ...
        #y_DMM.append(DMM[period*(j-1) : period*j, 1])
    ...
    figPath = os.path.join(figfilePath, "vel_spectrum/ori")####-------------------------------------------------------------------------change-------------------------------------------------------------
    ...
    xlabel = r"$\mathdefault{k}$"           #坐标标签
    ylabel = r"$\mathdefault{E(k)}$"
    xlimit = [1,40]                        #坐标显示范围
    ylimit = [1e-3,1e1]
    ...
    for i in range(len(time_advance)):
        ...
        gfile = "vel_spectra_t{}_label.png".format(j)               #保存的文件名
        ...
        # ----------------------------------------------------------------------------------------X坐标轴设置
        plt.xscale("log")                                     #画log
        ax.xaxis.set_minor_locator(mpl.ticker.LogLocator(base=10.0, subs=np.arange(0.1,1,0.1))) #次刻度
        formatter = mpl.ticker.LogFormatterSciNotation()      #主刻度格式
        ax.xaxis.set_major_formatter(formatter)               #应用主刻度格式
        ...
        plt.savefig(gpath, quality=100, bbox_inches='tight')
        print("Width x Hight: ", fig.get_size_inches())
        # plt.cl
'''       
    ################################# set figure path ################################
    figfilePath = os.path.abspath('./plot_results/{}case').format(case_number)
    figPath = os.path.join(figfilePath, "vel_spectrum/m01")####-------------------------------------------------------------------------change-------------------------------------------------------------
    if not os.path.exists(figPath):
        os.makedirs(figPath)
    print("图片存放路径：", figPath)
    ...
    for i in range(len(time_advance)):
        j = time_advance[i]                                   #输入的[1,5,10,15] #用于文件起名
        gfile = "vel_spectra_t{}.png".format(j)               #保存的文件名
        gpath = os.path.join(figPath, gfile)
        #-----------------------------------------------------------------------------------------图片大小分辨率
        fig = plt.figure(figsize=(width,height), dpi=dpi)     #定义图片宽、高、分辨率
        plt.rcParams["font.size"] = fontSize                  #统一字体大小
    ...
    ################################# set figure path ################################
    figfilePath = os.path.abspath('./plot_results/{}case').format(case_number)
    figPath = os.path.join(figfilePath, "vel_spectrum/m05")####-------------------------------------------------------------------------change-------------------------------------------------------------
    if not os.path.exists(figPath):
        os.makedirs(figPath)
    print("图片存放路径：", figPath)
    ...
    ################################# set figure path ################################
    figfilePath = os.path.abspath('./plot_results/{}case').format(case_number)
    figPath = os.path.join(figfilePath, "vel_spectrum/m1")####-------------------------------------------------------------------------change-------------------------------------------------------------
    if not os.path.exists(figPath):
        os.makedirs(figPath)
    print("图片存放路径：", figPath)
    ...
    ################################# set figure path ################################
    figfilePath = os.path.abspath('./plot_results/{}case').format(case_number)
    figPath = os.path.join(figfilePath, "vel_spectrum/m2")####-------------------------------------------------------------------------change-------------------------------------------------------------
    if not os.path.exists(figPath):
        os.makedirs(figPath)
    print("图片存放路径：", figPath)
    ...
    ################################# set figure path ################################
    figfilePath = os.path.abspath('./plot_results/{}case').format(case_number)
    figPath = os.path.join(figfilePath, "vel_spectrum/m5")####-------------------------------------------------------------------------change-------------------------------------------------------------
    if not os.path.exists(figPath):
        os.makedirs(figPath)
    print("图片存放路径：", figPath)
    ...
    xlimit = [1,40]                        #坐标显示范围
    ylimit = [1e-3,1e1]
    legend = ["F-IFNO_mag5", "F-IUFNO_mag5","IUFNO_mag5","IFNO_mag5","DSM_mag5","fDNS_mag5"]
    ############################## setting of fonts ####################################
    mpl.rc('font', family='STIXGeneral')
    mpl.rc('text', usetex=False)
    mpl.rcParams['xtick.direction'] = 'in'
    ...
    ################################# set figure path ################################
    figfilePath = os.path.abspath('./plot_results/{}case').format(case_number)
    figPath = os.path.join(figfilePath, "vel_spectrum/m10")####-------------------------------------------------------------------------change-------------------------------------------------------------
    if not os.path.exists(figPath):
        os.makedirs(figPath)
    print("图片存放路径：", figPath)
