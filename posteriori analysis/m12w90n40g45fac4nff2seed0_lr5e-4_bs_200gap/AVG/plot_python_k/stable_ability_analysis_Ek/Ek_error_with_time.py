...
for k, case_number in enumerate(case_number_list):
    ...
    for case_number in range(1, case_number+1):
        ...
        # IUFNO 数据加载
        IUFNO_0 = np.loadtxt("../../IUFNO_40ep_k=1,2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IUFNO_m01_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag0.1/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IUFNO_m05_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag0.5/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IUFNO_m1_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag1/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IUFNO_m2_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IUFNO_m5_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag5/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IUFNO_m10_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag10/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        
        # F_IUFNO 数据加载
        F_IUFNO_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m01_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag0.1/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m05_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag0.5/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m1_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag1/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m2_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m5_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag5/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m10_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag10/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        

        # F_IFNO数据加载
        F_IFNO_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m01_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag0.1/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m05_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag0.5/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m1_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag1/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m2_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m5_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag5/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m10_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag10/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)

        # IFNO 数据加载
        IFNO_0 = np.loadtxt("../../IFNO_40ep_k=1,2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IFNO_m01_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag0.1/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IFNO_m05_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag0.5/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IFNO_m1_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag1/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IFNO_m2_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IFNO_m5_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag5/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        IFNO_m10_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag10/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)


        
        # DSM 数据加载
        DSM_0 = np.loadtxt("../../DSM/N{}/avg_DSM_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        DSM_m01_0 = np.loadtxt("../../DSM_mag0.1/N{}/avg_DSM_mag0.1_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        DSM_m05_0 = np.loadtxt("../../DSM_mag0.5/N{}/avg_DSM_mag0.5_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        DSM_m1_0 = np.loadtxt("../../DSM_mag1/N{}/avg_DSM_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        DSM_m2_0 = np.loadtxt("../../DSM_mag2/N{}/avg_DSM_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        DSM_m5_0 = np.loadtxt("../../DSM_mag5/N{}/avg_DSM_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
        DSM_m10_0 = np.loadtxt("../../DSM_mag10/N{}/avg_DSM_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
    ...
    print("F_IFNO shape:", F_IFNO.shape)
    ...
    for i in range(case_number*time_steps):
        ...
        F_IFNO1=(F_IFNO[i, 1]-fDNS_time_avg)
        F_IUFNO1=(F_IUFNO[i, 1]-fDNS_time_avg)
        IUFNO1=(IUFNO[i, 1]-fDNS_time_avg)
        IFNO1=(IFNO[i, 1]-fDNS_time_avg)
        DSM1=(DSM[i, 1]-fDNS_time_avg)    
        fDNS1=(fDNS[i, 1]-fDNS_time_avg)
        
        F_IFNO1_m01=(F_IFNO_m01[i, 1]-fDNS_time_avg)
        F_IUFNO1_m01=(F_IUFNO_m01[i, 1]-fDNS_time_avg)
        IUFNO1_m01=(IUFNO_m01[i, 1]-fDNS_time_avg)
        IFNO1_m01=(IFNO_m01[i, 1]-fDNS_time_avg)
        DSM1_m01=(DSM_m01[i, 1]-fDNS_time_avg)        
        
        F_IFNO1_m05=(F_IFNO_m05[i, 1]-fDNS_time_avg)
        F_IUFNO1_m05=(F_IUFNO_m05[i, 1]-fDNS_time_avg)
        IUFNO1_m05=(IUFNO_m05[i, 1]-fDNS_time_avg)
        IFNO1_m05=(IFNO_m05[i, 1]-fDNS_time_avg)
        DSM1_m05=(DSM_m05[i, 1]-fDNS_time_avg) 
        
        F_IFNO1_m1=(F_IFNO_m1[i, 1]-fDNS_time_avg)
        F_IUFNO1_m1=(F_IUFNO_m1[i, 1]-fDNS_time_avg)
        IUFNO1_m1=(IUFNO_m1[i, 1]-fDNS_time_avg)
        IFNO1_m1=(IFNO_m1[i, 1]-fDNS_time_avg)
        DSM1_m1=(DSM_m1[i, 1]-fDNS_time_avg)         
        
        F_IFNO1_m2=(F_IFNO_m2[i, 1]-fDNS_time_avg)
        F_IUFNO1_m2=(F_IUFNO_m2[i, 1]-fDNS_time_avg)
        IUFNO1_m2=(IUFNO_m2[i, 1]-fDNS_time_avg)
        IFNO1_m2=(IFNO_m2[i, 1]-fDNS_time_avg)
        DSM1_m2=(DSM_m2[i, 1]-fDNS_time_avg)        
        
        F_IFNO1_m5=(F_IFNO_m5[i, 1]-fDNS_time_avg)
        F_IUFNO1_m5=(F_IUFNO_m5[i, 1]-fDNS_time_avg)
        IUFNO1_m5=(IUFNO_m5[i, 1]-fDNS_time_avg)
        IFNO1_m5=(IFNO_m5[i, 1]-fDNS_time_avg)
        DSM1_m5=(DSM_m5[i, 1]-fDNS_time_avg) 
        
        F_IFNO1_m10=(F_IFNO_m10[i, 1]-fDNS_time_avg)
        F_IUFNO1_m10=(F_IUFNO_m10[i, 1]-fDNS_time_avg)
        IUFNO1_m10=(IUFNO_m10[i, 1]-fDNS_time_avg)
        IFNO1_m10=(IFNO_m10[i, 1]-fDNS_time_avg)
        DSM1_m10=(DSM_m10[i, 1]-fDNS_time_avg)         
