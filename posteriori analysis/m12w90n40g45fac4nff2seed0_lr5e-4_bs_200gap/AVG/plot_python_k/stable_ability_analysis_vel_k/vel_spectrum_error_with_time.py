...
for k, case_number in enumerate(case_number_list):
    ...
    for case_number in range(1, case_number+1):
        ...
        # IUFNO 数据加载
        IUFNO_0 = np.loadtxt("../../IUFNO_40ep_k=1,2/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IUFNO_m01_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag0.1/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IUFNO_m05_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag0.5/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IUFNO_m1_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag1/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IUFNO_m2_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag2/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IUFNO_m5_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag5/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IUFNO_m10_0 = np.loadtxt("../../IUFNO_40ep_k=1,2_mag10/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        
        # F_IUFNO 数据加载
        F_IUFNO_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m01_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag0.1/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m05_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag0.5/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m1_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag1/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m2_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag2/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m5_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag5/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IUFNO_m10_0 = np.loadtxt("../../F-IUFNO_40ep_k=1,2_mag10/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        

        # F_IFNO数据加载
        F_IFNO_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m01_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag0.1/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m05_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag0.5/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m1_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag1/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m2_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag2/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m5_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag5/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        F_IFNO_m10_0 = np.loadtxt("../../F-IFNO_40ep_k=1,2_mag10/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)

        # IFNO 数据加载
        IFNO_0 = np.loadtxt("../../IFNO_40ep_k=1,2/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IFNO_m01_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag0.1/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IFNO_m05_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag0.5/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IFNO_m1_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag1/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IFNO_m2_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag2/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IFNO_m5_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag5/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
        IFNO_m10_0 = np.loadtxt("../../IFNO_40ep_k=1,2_mag10/N{}/avg_{}case_vel_spec.dat".format(case_number, case_number), dtype=float)
