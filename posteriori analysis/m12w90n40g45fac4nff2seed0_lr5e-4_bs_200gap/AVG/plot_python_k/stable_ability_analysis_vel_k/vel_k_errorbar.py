...
for kk, case_number in enumerate(case_number_list):
    for k, vel_k in enumerate(vel_k_list):
        ...
        mpl.rc('font', family='STIXGeneral')
        # 创建图例
        #lgd = plt.legend(loc='lower right', fontsize=45, ncol=2, frameon=True, framealpha=0, edgecolor='black', shadow=False)
        ...
        gfile1 = "Errorbar for E[k={}]_mag_label.png".format(vel_k)
