...
for k, vel_k in enumerate(vel_k_list):
    ...
    if vel_k==1:
        ylimit = [-0.00000032,0.00000012]
    elif vel_k==2:
        ylimit = [-0.0000001,0.00000004]
    elif vel_k==3:
        ylimit = [-0.04,0.06]        
    elif vel_k==4:
        ylimit = [-0.05,0.05]        
    ...
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m01").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m05").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m1").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m2").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m5").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m10").format(vel_k)
