...
for kk, case_number in enumerate(case_number_list):
    ...
    #-------------------------------------------------------------读入数据，
       ...
       # 直方图数据
        ...
        #绘制原始频率密度曲线（虚线）
        plt.plot(bin_centers, hist, linestyle="--", color=colors[0], label=f"Data density", linewidth=2,zorder=1)
        # 绘制直方圖结果
        plt.hist(data1, bins=50, density=True,alpha=0.6,color=colors[0], label=f"Data histogram",zorder=0)
        
        plt.title(r'Normal distribution fit for E(k={}) error: fDNS'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
        plt.legend(loc='upper right', fontsize=22)  # 添加图例并设置位置
        # 设置边框颜色
       ...
       # 直方图数据
        ...
        #绘制原始频率密度曲线（虚线）
        plt.plot(bin_centers, hist, linestyle="--", color=colors[39], label=f"Data density", linewidth=2,zorder=1)
        # 绘制直方圖结果
        plt.hist(data2, bins=50, density=True,alpha=0.6,color=colors[39], label=f"Data histogram",zorder=0)
        
        plt.title(r'Skew normal distribution fit for E(k={}) error: F-IUFNO'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
       ...
       # 直方图数据
        ...
        plt.plot(x, pdf, 'k-',linewidth=2, zorder=2,label=f'Fit: $\\alpha={alpha_fit:.4f}$, $\\mu={mu_fit:.4f}$, $\\sigma={sigma_fit:.4f}$')
        #绘制原始频率密度曲线（虚线）
        plt.plot(bin_centers, hist, linestyle="--", color=colors[2], label=f"Data density", linewidth=2,zorder=1)
        # 绘制直方圖结果
        plt.hist(data3, bins=50, density=True,alpha=0.6,color=colors[2], label=f"Data histogram",zorder=0)
        
        plt.title(r'Skew normal distribution fit for E(k={}) error: F-IFNO'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
       ...
       # 直方图数据
        ...
        plt.plot(x, pdf, 'k-', label=f"Fit: $\mu={mu:.4f}, \sigma={std:.4f}$", linewidth=2,zorder=2)
        #绘制原始频率密度曲线（虚线）
        plt.plot(bin_centers, hist, linestyle="--", color=colors[7], label=f"Data density", linewidth=2,zorder=1)
        # 绘制直方圖结果
        plt.hist(data4, bins=50, density=True,alpha=0.6,color=colors[7], label=f"Data histogram",zorder=0)
        
        plt.title(r'Normal distribution fit for E(k={}) error: DSM'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
       ...
       # 直方图数据
        ...
        plt.plot(x, pdf, 'k-',linewidth=2, zorder=2,label=f'Fit: $\\alpha={alpha_fit:.4f}$, $\\mu={mu_fit:.4f}$, $\\sigma={sigma_fit:.4f}$')
        #绘制原始频率密度曲线（虚线）
        plt.plot(bin_centers, hist, linestyle="--", color=colors[14], label=f"Data density", linewidth=2,zorder=1)
        # 绘制直方圖结果
        plt.hist(data5, bins=50, density=True,alpha=0.6,color=colors[14], label=f"Data histogram",zorder=0)
        
        plt.title(r'Skew normal distribution fit for E(k={}) error: IUFNO'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
       ...
       # 直方图数据
        ...
        plt.plot(x, pdf, 'k-',linewidth=2, zorder=2,label=f'Fit: $\\alpha={alpha_fit:.4f}$, $\\mu={mu_fit:.4f}$, $\\sigma={sigma_fit:.4f}$')
        #绘制原始频率密度曲线（虚线）
        plt.plot(bin_centers, hist, linestyle="--", color=colors[28], label=f"Data density", linewidth=2,zorder=1)
        # 绘制直方圖结果
        plt.hist(data6, bins=50, density=True,alpha=0.6,color=colors[28], label=f"Data histogram",zorder=0)
        
        plt.title(r'Skew normal distribution fit for E(k={}) error: IFNO'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
  ...
  ####################################################################################################################       
       ...
       # 直方图数据
        ...
        plt.title(r'Normal distribution fit for E(k={}) error: F-IUFNO'.format(vel_k), fontsize=22)
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
        ...
        # 去除网格线
        plt.grid(False)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_F-IUFNO_k={}_gs.png'.format(case_number,vel_k,vel_k), dpi=300)
       ...
       # 直方图数据
        ...
        plt.title(r'Normal distribution fit for E(k={}) error: F-IFNO'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
        ...
        # 去除网格线
        plt.grid(False)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_F-IFNO_k={}_gs.png'.format(case_number,vel_k,vel_k), dpi=300)  
       ...
       # 直方图数据
        ...
        plt.title(r'Normal distribution fit for E(k={}) error: IUFNO'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
        ...
        # 去除网格线
        plt.grid(False)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_IUFNO_k={}_gs.png'.format(case_number,vel_k,vel_k), dpi=300) 
       ...
       # 直方图数据
        ...
        plt.title(r'Normal distribution fit for E(k={}) error: IFNO'.format(vel_k), fontsize=22) 
        plt.xlabel('Error', fontsize=22)  # x 轴标签
        plt.ylabel('Density', fontsize=22)  # y 轴标签
        plt.xticks(fontsize=22)  # x 轴刻度字体大小
        plt.yticks(fontsize=22)  # y 轴刻度字体大小
        ...
        # 去除网格线
        plt.grid(False)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_IFNO_k={}_gs.png'.format(case_number,vel_k,vel_k), dpi=300) 
