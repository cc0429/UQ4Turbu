...
for k, case_number in enumerate(case_number_list):
    ...
    colors = [
        ...
        '#BA55D3', '#00FA9A', '#sF4A460', '#FFB6C1', '#00CED1', 
        '#DC143C', '#4169E1', '#4682B4', '#008000'                      # 新增颜色至50种
    ]

    # 绘制 PDF
    #1
    plt.figure(figsize=(9.5,6.5), facecolor='none')  # 设置图形大小
    plt.rcParams['text.color'] = 'black'  # 字体颜色
    # 绘制直方图
    sns.distplot(data1, bins=50, hist=True, kde=False, hist_kws={'color':colors[0]}, norm_hist=True,label='Data histogram')
    # 绘制核密度估计
    sns.distplot(data1, hist=False, kde=True, kde_kws={'color':colors[0], 'linestyle':'-'}, norm_hist=True,label='Data density')
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: fDNS', fontsize=24)  
    ...
    plt.rcParams['text.color'] = 'black'  # 字体颜色
    # 绘制直方图
    sns.distplot(data2, bins=50, hist=True, kde=False, hist_kws={'color':colors[14]}, norm_hist=True,label='Data histogram')
    # 绘制核密度估计
    sns.distplot(data2, hist=False, kde=True, kde_kws={'color':colors[14], 'linestyle':'-'}, norm_hist=True,label='Data density')
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: IUFNO', fontsize=24)  
    plt.xlabel('Error', fontsize=24)  # x 轴标签
    plt.ylabel('Density', fontsize=24)  # y 轴标签
    plt.xticks(fontsize=24)  # x 轴刻度字体大小
    plt.yticks(fontsize=24)  # y 轴刻度字体大小
    ...
    plt.rcParams['text.color'] = 'black'  # 字体颜色
    # 绘制直方图
    sns.distplot(data3, bins=50, hist=True, kde=False, hist_kws={'color':colors[39]}, norm_hist=True,label='Data histogram')
    # 绘制核密度估计
    sns.distplot(data3, hist=False, kde=True, kde_kws={'color':colors[39], 'linestyle':'-'}, norm_hist=True,label='Data density')
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: F-IUFNO', fontsize=24)  
    plt.xlabel('Error', fontsize=24)  # x 轴标签
    plt.ylabel('Density', fontsize=24)  # y 轴标签
    plt.xticks(fontsize=24)  # x 轴刻度字体大小
    plt.yticks(fontsize=24)  # y 轴刻度字体大小
    ...
    plt.rcParams['text.color'] = 'black'  # 字体颜色
    # 绘制直方图
    sns.distplot(data4, bins=50, hist=True, kde=False, hist_kws={'color':colors[2]}, norm_hist=True,label='Data histogram')
    # 绘制核密度估计
    sns.distplot(data4, hist=False, kde=True, kde_kws={'color':colors[2], 'linestyle':'-'}, norm_hist=True,label='Data density')
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: F-IFNO', fontsize=24)  
    plt.xlabel('Error', fontsize=24)  # x 轴标签
    plt.ylabel('Density', fontsize=24)  # y 轴标签
    plt.xticks(fontsize=24)  # x 轴刻度字体大小
    plt.yticks(fontsize=24)  # y 轴刻度字体大小
    ...
    plt.rcParams['text.color'] = 'black'  # 字体颜色
    # 绘制直方图
    sns.distplot(data5, bins=50, hist=True, kde=False, hist_kws={'color':colors[28]}, norm_hist=True,label='Data histogram')
    # 绘制核密度估计
    sns.distplot(data5, hist=False, kde=True, kde_kws={'color':colors[28], 'linestyle':'-'}, norm_hist=True,label='Data density')
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: IFNO', fontsize=24)  
    plt.xlabel('Error', fontsize=24)  # x 轴标签
    plt.ylabel('Density', fontsize=24)  # y 轴标签
    plt.xticks(fontsize=24)  # x 轴刻度字体大小
    plt.yticks(fontsize=24)  # y 轴刻度字体大小
    ...
    plt.rcParams['text.color'] = 'black'  # 字体颜色
    # 绘制直方图
    sns.distplot(data6, bins=50, hist=True, kde=False, hist_kws={'color':colors[7]}, norm_hist=True,label='Data histogram')
    # 绘制核密度估计
    sns.distplot(data6, hist=False, kde=True, kde_kws={'color':colors[7], 'linestyle':'-'}, norm_hist=True,label='Data density')
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: DSM', fontsize=24)  
    plt.xlabel('Error', fontsize=24)  # x 轴标签
    plt.ylabel('Density', fontsize=24)  # y 轴标签
    plt.xticks(fontsize=24)  # x 轴刻度字体大小
    plt.yticks(fontsize=24)  # y 轴刻度字体大小
