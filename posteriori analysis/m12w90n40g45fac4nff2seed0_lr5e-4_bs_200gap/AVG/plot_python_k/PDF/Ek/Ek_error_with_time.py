...
for k, case_number in enumerate(case_number_list):
    ...
    for case_number in range(1, case_number+1):
        ...
        # IUFNO_40ep 数据加载
        IUFNO_40ep_0 = np.loadtxt("../../../IUFNO_40ep_k=1,2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)

        # F_IUFNO_40ep 数据加载
        F_IUFNO_40ep_0 = np.loadtxt("../../../F-IUFNO_40ep_k=1,2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)

        # F_IFNO_40ep 数据加载
        F_IFNO_40ep_0 = np.loadtxt("../../../F-IFNO_40ep_k=1,2/N{}/avg_{}case_Ek_t.dat".format(case_number, case_number), dtype=float)
