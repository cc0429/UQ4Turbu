...
for k, case_number in enumerate(case_number_list):
    ...
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: fDNS', fontsize=18)  
    ...
    # 去除网格线
    plt.grid(False)
    plt.savefig('./pdf/{}cases/pdf_fDNS.png'.format(case_number), dpi=300)  
    ...
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: IUFNO', fontsize=18)  
    plt.xlabel('Error', fontsize=18)  # x 轴标签
    plt.ylabel('Density', fontsize=18)  # y 轴标签
    plt.xticks(fontsize=20)  # x 轴刻度字体大小
    plt.yticks(fontsize=20)  # y 轴刻度字体大小
    ...
    # 去除网格线
    plt.grid(False)
    plt.savefig('./pdf/{}cases/pdf_IUFNO.png'.format(case_number), dpi=300)  
    ...
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: F-IUFNO', fontsize=18)  
    plt.xlabel('Error', fontsize=18)  # x 轴标签
    plt.ylabel('Density', fontsize=18)  # y 轴标签
    plt.xticks(fontsize=20)  # x 轴刻度字体大小
    plt.yticks(fontsize=20)  # y 轴刻度字体大小
    ...
    # 去除网格线
    plt.grid(False)
    plt.savefig('./pdf/{}cases/pdf_F-IUFNO.png'.format(case_number), dpi=300)  
    ...
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: F-IFNO', fontsize=18)  
    plt.xlabel('Error', fontsize=18)  # x 轴标签
    plt.ylabel('Density', fontsize=18)  # y 轴标签
    plt.xticks(fontsize=20)  # x 轴刻度字体大小
    plt.yticks(fontsize=20)  # y 轴刻度字体大小
    ...
    # 去除网格线
    plt.grid(False)
    plt.savefig('./pdf/{}cases/pdf_F-IFNO.png'.format(case_number), dpi=300)
    ...
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: IFNO', fontsize=18)  
    plt.xlabel('Error', fontsize=18)  # x 轴标签
    plt.ylabel('Density', fontsize=18)  # y 轴标签
    plt.xticks(fontsize=20)  # x 轴刻度字体大小
    plt.yticks(fontsize=20)  # y 轴刻度字体大小
    ...
    # 去除网格线
    plt.grid(False)
    plt.savefig('./pdf/{}cases/pdf_IFNO.png'.format(case_number), dpi=300)  
    ...
    # 图标题
    plt.title(r'Probability density function (PDF) of $\mathdefault{E_k}$ error: DSM', fontsize=18)  
    plt.xlabel('Error', fontsize=18)  # x 轴标签
    plt.ylabel('Density', fontsize=18)  # y 轴标签
    plt.xticks(fontsize=20)  # x 轴刻度字体大小
    plt.yticks(fontsize=20)  # y 轴刻度字体大小
    ...
    # 去除网格线
    plt.grid(False)
    plt.savefig('./pdf/{}cases/pdf_DSM.png'.format(case_number), dpi=300)  
