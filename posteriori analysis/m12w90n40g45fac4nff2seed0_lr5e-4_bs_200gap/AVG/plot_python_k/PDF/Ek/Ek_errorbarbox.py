...
for k, case_number in enumerate(case_number_list):
    ...
    ylabel = r"$\mathdefault{Error \ distribution \ for \ E_k}$"
    #ylimit = [-0.8, 0.4]
    ...
    mpl.rc('font', family='STIXGeneral')
    # 创建图例
    #plt.title("Error Distribution for Ek", fontsize=30, color='black', loc='center', pad=15)

    # 显示网格
    #plt.grid()
    figPath1 = os.path.abspath("./Ek_errorbar/{}cases".format(case_number))
    gfile1 = "Errorbarbox for Ek_model.png"
