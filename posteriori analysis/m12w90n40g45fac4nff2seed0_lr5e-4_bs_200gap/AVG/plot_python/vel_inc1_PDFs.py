...
for idx, case_number in enumerate(case_number_list):
    ...
    IUFNO = np.loadtxt("../IUFNO_40ep/{}case/avg_IUFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IUFNO = np.loadtxt("../F-IUFNO_40ep/{}case/avg_FIUFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IFNO = np.loadtxt("../F-IFNO_40ep/{}case/avg_FIFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    IFNO = np.loadtxt("../IFNO_40ep/{}case/avg_IFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    DSM = np.loadtxt("../DSM/{}case/avg_DSM_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)

    IUFNO_m01 = np.loadtxt("../IUFNO_40ep_mag0.1/{}case/avg_IUFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m01 = np.loadtxt("../F-IUFNO_40ep_mag0.1/{}case/avg_FIUFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m01 = np.loadtxt("../F-IFNO_40ep_mag0.1/{}case/avg_FIFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    IFNO_m01 = np.loadtxt("../IFNO_40ep_mag0.1/{}case/avg_IFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    DSM_m01 = np.loadtxt("../DSM_mag0.1/{}case/avg_DSM_mag0.1_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)

    IUFNO_m05 = np.loadtxt("../IUFNO_40ep_mag0.5/{}case/avg_IUFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m05 = np.loadtxt("../F-IUFNO_40ep_mag0.5/{}case/avg_FIUFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m05 = np.loadtxt("../F-IFNO_40ep_mag0.5/{}case/avg_FIFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    IFNO_m05 = np.loadtxt("../IFNO_40ep_mag0.5/{}case/avg_IFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    DSM_m05 = np.loadtxt("../DSM_mag0.5/{}case/avg_DSM_mag0.5_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)

    IUFNO_m1 = np.loadtxt("../IUFNO_40ep_mag1/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m1 = np.loadtxt("../F-IUFNO_40ep_mag1/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m1 = np.loadtxt("../F-IFNO_40ep_mag1/{}case/avg_FIFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    IFNO_m1 = np.loadtxt("../IFNO_40ep_mag1/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    DSM_m1 = np.loadtxt("../DSM_mag1/{}case/avg_DSM_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)

    IUFNO_m2 = np.loadtxt("../IUFNO_40ep_mag2/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m2 = np.loadtxt("../F-IUFNO_40ep_mag2/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m2 = np.loadtxt("../F-IFNO_40ep_mag2/{}case/avg_FIFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    IFNO_m2 = np.loadtxt("../IFNO_40ep_mag2/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    DSM_m2 = np.loadtxt("../DSM_mag2/{}case/avg_DSM_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)

    IUFNO_m5 = np.loadtxt("../IUFNO_40ep_mag5/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m5 = np.loadtxt("../F-IUFNO_40ep_mag5/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m5 = np.loadtxt("../F-IFNO_40ep_mag5/{}case/avg_FIFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    IFNO_m5 = np.loadtxt("../IFNO_40ep_mag5/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    DSM_m5 = np.loadtxt("../DSM_mag5/{}case/avg_DSM_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    
    IUFNO_m10 = np.loadtxt("../IUFNO_40ep_mag10/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IUFNO_m10 = np.loadtxt("../F-IUFNO_40ep_mag10/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    F_IFNO_m10 = np.loadtxt("../F-IFNO_40ep_mag10/{}case/avg_FIFNO_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    IFNO_m10 = np.loadtxt("../IFNO_40ep_mag10/{}case/avg_{}case_inc1_PDFs.dat".format(case_number, case_number), dtype=float)
    ...
    for i in range(len(time_advance)):
        ...
        gfile = "vel_inc1_PDFs_t{}_lable.png".format(j)               #保存的文件名
