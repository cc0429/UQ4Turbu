...
for kk, case_number in enumerate(case_number_list):
    ...
    colors = ['#A52A2A','#ff7f0e','#ffd700','green','#1f77b4','purple', '#ff007f', '#7f7f7f']
    ...
    plt.plot(x1, mean1_F_IFNO, color=colors[0], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=6)
    plt.errorbar(x1, mean1_F_IFNO, yerr=std1_F_IFNO, fmt='o', color=colors[0], ecolor=colors[0], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[0],zorder=6)

    plt.plot(x1, mean1_F_IFNO_m01, color=colors[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=5)
    plt.errorbar(x1, mean1_F_IFNO_m01, yerr=std1_F_IFNO_m01, fmt='o', color=colors[1], ecolor=colors[1], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[1],zorder=5)

    plt.plot(x1, mean1_F_IFNO_m05, color=colors[2], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    plt.errorbar(x1, mean1_F_IFNO_m05, yerr=std1_F_IFNO_m05, fmt='o', color=colors[2], ecolor=colors[2], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[2],zorder=4)

    plt.plot(x1, mean1_F_IFNO_m1, color=colors[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1, mean1_F_IFNO_m1, yerr=std1_F_IFNO_m1, fmt='o', color=colors[3], ecolor=colors[3], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[3],zorder=3)

    plt.plot(x1, mean1_F_IFNO_m2, color=colors[4], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    plt.errorbar(x1, mean1_F_IFNO_m2, yerr=std1_F_IFNO_m2, fmt='o', color=colors[4], ecolor=colors[4], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[4],zorder=2)

    plt.plot(x1, mean1_F_IFNO_m5, color=colors[5], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=1)
    plt.errorbar(x1, mean1_F_IFNO_m5, yerr=std1_F_IFNO_m5, fmt='o', color=colors[5], ecolor=colors[5], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[5],zorder=1)

    plt.plot(x1, mean1_F_IFNO_m10, color=colors[6], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_F_IFNO_m10, yerr=std1_F_IFNO_m10, fmt='o', color=colors[6], ecolor=colors[6], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[6],zorder=0)

    plt.plot(x1, mean1_fDNS, color=colors[7], alpha=0.8, linewidth=3*lineWidth, linestyle='--',zorder=7)
    plt.errorbar(x1, mean1_fDNS, yerr=std1_fDNS, fmt='o', color=colors[7], ecolor=colors[7], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[7],zorder=7)

    # Matplotlib 配置 - 全局字体设置为 STIXGeneral
    mpl.rc('font', family='STIXGeneral')
    # 创建图例
    #lgd = plt.legend(loc='lower right', fontsize=70, frameon=True, framealpha=0, edgecolor='black', shadow=False)
    #plt.title("spectrum errorbar".format(vel_k), fontsize=70, color='black', loc='center', pad=15)

    # 显示网格
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar_with_mag_with_k/{}cases".format(case_number))
    gfile1 = "spectrum errorbar for F-IFNO_label.png"
    ...
    plt.plot(x1, mean1_F_IUFNO, color=colors[0], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=6)
    plt.errorbar(x1, mean1_F_IUFNO, yerr=std1_F_IUFNO, fmt='o', color=colors[0], ecolor=colors[0], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[0],zorder=6)

    plt.plot(x1, mean1_F_IUFNO_m01, color=colors[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=5)
    plt.errorbar(x1, mean1_F_IUFNO_m01, yerr=std1_F_IUFNO_m01, fmt='o', color=colors[1], ecolor=colors[1], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[1],zorder=5)

    plt.plot(x1, mean1_F_IUFNO_m05, color=colors[2], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    plt.errorbar(x1, mean1_F_IUFNO_m05, yerr=std1_F_IUFNO_m05, fmt='o', color=colors[2], ecolor=colors[2], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[2],zorder=4)

    plt.plot(x1, mean1_F_IUFNO_m1, color=colors[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1, mean1_F_IUFNO_m1, yerr=std1_F_IUFNO_m1, fmt='o', color=colors[3], ecolor=colors[3], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[3],zorder=3)

    plt.plot(x1, mean1_F_IUFNO_m2, color=colors[4], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    plt.errorbar(x1, mean1_F_IUFNO_m2, yerr=std1_F_IUFNO_m2, fmt='o', color=colors[4], ecolor=colors[4], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[4],zorder=2)

    plt.plot(x1, mean1_F_IUFNO_m5, color=colors[5], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=1)
    plt.errorbar(x1, mean1_F_IUFNO_m5, yerr=std1_F_IUFNO_m5, fmt='o', color=colors[5], ecolor=colors[5], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[5],zorder=1)

    plt.plot(x1, mean1_F_IUFNO_m10, color=colors[6], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_F_IUFNO_m10, yerr=std1_F_IUFNO_m10, fmt='o', color=colors[6], ecolor=colors[6], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[6],zorder=0)
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar_with_mag_with_k/{}cases".format(case_number))
    gfile1 = "spectrum errorbar for F-IUFNO_label.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
    ...
    plt.plot(x1, mean1_IUFNO, color=colors[0], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=6)
    plt.errorbar(x1, mean1_IUFNO, yerr=std1_IUFNO, fmt='o', color=colors[0], ecolor=colors[0], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[0],zorder=6)

    plt.plot(x1, mean1_IUFNO_m01, color=colors[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=5)
    plt.errorbar(x1, mean1_IUFNO_m01, yerr=std1_IUFNO_m01, fmt='o', color=colors[1], ecolor=colors[1], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[1],zorder=5)

    plt.plot(x1, mean1_IUFNO_m05, color=colors[2], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    plt.errorbar(x1, mean1_IUFNO_m05, yerr=std1_IUFNO_m05, fmt='o', color=colors[2], ecolor=colors[2], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[2],zorder=4)

    plt.plot(x1, mean1_IUFNO_m1, color=colors[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1, mean1_IUFNO_m1, yerr=std1_IUFNO_m1, fmt='o', color=colors[3], ecolor=colors[3], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[3],zorder=3)

    plt.plot(x1, mean1_IUFNO_m2, color=colors[4], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    plt.errorbar(x1, mean1_IUFNO_m2, yerr=std1_IUFNO_m2, fmt='o', color=colors[4], ecolor=colors[4], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[4],zorder=2)

    plt.plot(x1, mean1_IUFNO_m5, color=colors[5], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=1)
    plt.errorbar(x1, mean1_IUFNO_m5, yerr=std1_IUFNO_m5, fmt='o', color=colors[5], ecolor=colors[5], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[5],zorder=1)

    plt.plot(x1, mean1_IUFNO_m10, color=colors[6], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_IUFNO_m10, yerr=std1_IUFNO_m10, fmt='o', color=colors[6], ecolor=colors[6], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[6],zorder=0)
    ...
    mpl.rc('font', family='STIXGeneral')
    # 创建图例
    #lgd = plt.legend(loc='upper right', fontsize=70, frameon=True, framealpha=0, edgecolor='black', shadow=False)
    #plt.title("spectrum errorbar".format(vel_k), fontsize=70, color='black', loc='center', pad=15)

    # 显示网格
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar_with_mag_with_k/{}cases".format(case_number))
    gfile1 = "spectrum errorbar for IUFNO_label.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
    ...
    plt.plot(x1, mean1_IFNO, color=colors[0], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=6)
    plt.errorbar(x1, mean1_IFNO, yerr=std1_IFNO, fmt='o', color=colors[0], ecolor=colors[0], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[0],zorder=6)

    plt.plot(x1, mean1_IFNO_m01, color=colors[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=5)
    plt.errorbar(x1, mean1_IFNO_m01, yerr=std1_IFNO_m01, fmt='o', color=colors[1], ecolor=colors[1], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[1],zorder=5)

    plt.plot(x1, mean1_IFNO_m05, color=colors[2], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    plt.errorbar(x1, mean1_IFNO_m05, yerr=std1_IFNO_m05, fmt='o', color=colors[2], ecolor=colors[2], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[2],zorder=4)

    plt.plot(x1, mean1_IFNO_m1, color=colors[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1, mean1_IFNO_m1, yerr=std1_IFNO_m1, fmt='o', color=colors[3], ecolor=colors[3], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[3],zorder=3)

    plt.plot(x1, mean1_IFNO_m2, color=colors[4], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    plt.errorbar(x1, mean1_IFNO_m2, yerr=std1_IFNO_m2, fmt='o', color=colors[4], ecolor=colors[4], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[4],zorder=2)

    plt.plot(x1, mean1_IFNO_m5, color=colors[5], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=1)
    plt.errorbar(x1, mean1_IFNO_m5, yerr=std1_IFNO_m5, fmt='o', color=colors[5], ecolor=colors[5], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[5],zorder=1)

    plt.plot(x1, mean1_IFNO_m10, color=colors[6], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_IFNO_m10, yerr=std1_IFNO_m10, fmt='o', color=colors[6], ecolor=colors[6], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[6],zorder=0)
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar_with_mag_with_k/{}cases".format(case_number))
    gfile1 = "spectrum errorbar for IFNO_label.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
    ...
    plt.plot(x1, mean1_DSM, color=colors[0], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    plt.errorbar(x1, mean1_DSM, yerr=std1_DSM, fmt='o', color=colors[0], ecolor=colors[0], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[0],zorder=4)

    plt.plot(x1, mean1_DSM_m01, color=colors[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1, mean1_DSM_m01, yerr=std1_DSM_m01, fmt='o', color=colors[1], ecolor=colors[1], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[1],zorder=3)

    plt.plot(x1, mean1_DSM_m05, color=colors[2], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    plt.errorbar(x1, mean1_DSM_m05, yerr=std1_DSM_m05, fmt='o', color=colors[2], ecolor=colors[2], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[2],zorder=2)

    plt.plot(x1, mean1_DSM_m1, color=colors[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=1)
    plt.errorbar(x1, mean1_DSM_m1, yerr=std1_DSM_m1, fmt='o', color=colors[3], ecolor=colors[3], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[3],zorder=1)

    plt.plot(x1, mean1_DSM_m2, color=colors[4], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_DSM_m2, yerr=std1_DSM_m2, fmt='o', color=colors[4], ecolor=colors[4], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[4],zorder=0)

    plt.plot(x1, mean1_fDNS, color=colors[7], alpha=0.8, linewidth=3*lineWidth, linestyle='--',zorder=5)
    plt.errorbar(x1, mean1_fDNS, yerr=std1_fDNS, fmt='o', color=colors[7], ecolor=colors[7], capsize=10, elinewidth=6, markeredgewidth=6, label=legend1[7],zorder=5)
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar_with_mag_with_k/{}cases".format(case_number))
    gfile1 = "spectrum errorbar for DSM_label.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
