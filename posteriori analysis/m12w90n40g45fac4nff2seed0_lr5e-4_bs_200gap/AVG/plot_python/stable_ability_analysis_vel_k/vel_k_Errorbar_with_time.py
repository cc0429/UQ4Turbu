...
for k, vel_k in enumerate(vel_k_list):
    ...
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m01_6").format(vel_k)
    ...
    #plt.title("Mean ± Std error of E[k={}]".format(vel_k), fontsize=30, color='black', loc='center', pad=15)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m05_6").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m1_6").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m2_6").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m5_6").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m10_6").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m01_4").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m05_4").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m1_4").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m2_4").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m5_4").format(vel_k)
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_m10_4").format(vel_k)
