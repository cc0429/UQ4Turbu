...
for kk, case_number in enumerate(case_number_list):
    ...
    gfile1 = "Errorbar for E[k=1-10]_mag_F-IFNO_label.png".format(vel_k)
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases".format(case_number))
    gfile1 = "Errorbar for E[k=1-10]_mag_F-IUFNO_label.png".format(vel_k)
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases".format(case_number))
    gfile1 = "Errorbar for E[k=1-10]_mag_IUFNO_label.png".format(vel_k)
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases".format(case_number))
    gfile1 = "Errorbar for E[k=1-10]_mag_IFNO_label.png".format(vel_k)
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases".format(case_number))
    gfile1 = "Errorbar for E[k=1-10]_mag_DSM_label.png".format(vel_k)
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
