...
for k, vel_k in enumerate(vel_k_list):
    ...
    ######################### set figure path1 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_ori_6").format(vel_k)
    ...
    ylabel = r"$\mathdefault{{Mean \pm Std \ error \ of \ E(k={})}}$".format(vel_k)
    xlimit = [1,121]                        #坐标显示范围
    #ylimit = [-60,60]
    ...
    step1=1
    plt.plot(x, mean1, label=legend[5], color='purple', linewidth=lineWidth1, linestyle='solid',zorder=1)
    plt.fill_between(x, mean1 - std1, mean1 + std1, color='purple', alpha=0.3)

    plt.plot(x, mean2, label=legend[0], color='#1f77b4', linewidth=lineWidth, linestyle='solid',zorder=1)
    plt.fill_between(x, mean2 - std2, mean2 + std2, color='#1f77b4', alpha=0.3)

    plt.plot(x, mean3, label=legend[1], color='#ff7f0e', linewidth=lineWidth, linestyle='solid',zorder=0)
    plt.fill_between(x, mean3 - std3, mean3 + std3, color='#ff7f0e', alpha=0.3)

    plt.plot(x, mean4, label=legend[2], color='gold', linewidth=lineWidth, linestyle='solid',zorder=0)
    plt.fill_between(x, mean4 - std4, mean4 + std4, color='gold', alpha=0.3)

    plt.plot(x, mean5, label=legend[3], color='pink', linewidth=lineWidth, linestyle='solid',zorder=0)
    plt.fill_between(x, mean5 - std5, mean5 + std5, color='pink', alpha=0.3)

    plt.plot(x, mean6, label=legend[4], color='green', linewidth=lineWidth, linestyle='solid',zorder=1)
    plt.fill_between(x, mean6 - std6, mean6 + std6, color='green', alpha=0.3)

    lgd_loc  = (0.75,0.62)#6 7#6 80 88
    ...
    #plt.title(r"Mean ± Std error of E(k={})".format(vel_k), fontsize=30, color='black', loc='center', pad=15)
    ...
    ######################### set figure path2 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_ori_5").format(vel_k)
    ...
    ######################### set figure path3 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_ori_2").format(vel_k)
    ...
    ######################### set figure path4 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_ori_3").format(vel_k)
    ...
    ######################### set figure path4 ################################
    figfilePath = os.path.abspath('./Errorbar_with_time/k={}/').format(vel_k)
    figPath = os.path.join(figfilePath, "k={}_Errorbar_with_time_30cases_ori_4").format(vel_k)
