...
for kk, case_number in enumerate(case_number_list):
    ...
    #-------------------------------------------------------------读入数据，
       ...
       # 直方图数据
        ...
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Normal distribution fit for E(k={}) fluctuation: fDNS'.format(vel_k), fontsize=40, pad=10) 
        ...
        plt.savefig('./GSfit/{}cases/k={}/GSfit_fDNS_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_fDNS_k={}.dat".format(case_number,vel_k,vel_k)
        ...
        for i, (dist_name, dist) in enumerate(distributions.items(), 1):
            ...
            plt.rcParams['mathtext.fontset'] = 'cm'    
            plt.title(fr"QQ Plot of {dist_name} for E(k={vel_k}) fluctuation: fDNS", fontsize=18)
        ...
        plt.tight_layout()      
        plt.savefig('./GSfit/{}cases/k={}/QQPlot_fDNS_k={}.png'.format(case_number,vel_k,vel_k), dpi=300) 
       ...
       # 直方图数据
        ...
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Skew normal distribution fit for E(k={}) error: F-IUFNO'.format(vel_k), fontsize=40, pad=10) 
        ...
        #plt.ylim(0, 10) 
        plt.subplots_adjust(bottom=0.31)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_F-IUFNO_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_F-IUFNO_k={}.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
        ...
        for i, (dist_name, dist) in enumerate(distributions.items(), 1):
            ...
            plt.rcParams['mathtext.fontset'] = 'cm'    
            plt.title(fr"QQ Plot of {dist_name} for E(k={vel_k}) error: F-IUFNO", fontsize=18)
            # 设置刻度字体大小
            plt.xticks(fontsize=21)
            plt.yticks(fontsize=21)
            plt.gca().get_lines()[1].set_linewidth(4)
        ...
        plt.tight_layout()  
        plt.savefig('./GSfit/{}cases/k={}/QQPlot_F-IUFNO_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)       
       ...
       # 直方图数据
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_F-IFNO_k={}.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
        ...
        for i, (dist_name, dist) in enumerate(distributions.items(), 1):
            ...
            plt.rcParams['mathtext.fontset'] = 'cm'    
            plt.title(fr"QQ Plot of {dist_name} for E(k={vel_k}) error: F-IFNO", fontsize=18)
            # 设置刻度字体大小
            plt.xticks(fontsize=21)
            plt.yticks(fontsize=21)
            plt.gca().get_lines()[1].set_linewidth(4)
        ...
        plt.tight_layout()  
        plt.savefig('./GSfit/{}cases/k={}/QQPlot_F-IFNO_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
       ...
       # 直方图数据
        ...
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Normal distribution fit for E(k={}) error: DSM'.format(vel_k), fontsize=40, pad=10) 
        plt.xlabel('Error', fontsize=40)  # x 轴标签
        plt.ylabel('Density', fontsize=40)  # y 轴标签
        plt.xticks(fontsize=40)  # x 轴刻度字体大小
        plt.yticks(fontsize=40)  # y 轴刻度字体大小
        ...
        #plt.ylim(0, 11) 
        plt.subplots_adjust(bottom=0.31)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_DSM_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_DSM_k={}.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
        ...
        for i, (dist_name, dist) in enumerate(distributions.items(), 1):
            ...
            plt.rcParams['mathtext.fontset'] = 'cm'
            plt.title(fr"QQ Plot of {dist_name} for E(k={vel_k}) error: DSM", fontsize=18)       
            # 设置刻度字体大小
            plt.xticks(fontsize=21)
            plt.yticks(fontsize=21)
            plt.gca().get_lines()[1].set_linewidth(4)
            ...
            ax.set_ylabel(ax.get_ylabel(), fontsize=21)
        plt.tight_layout()      
        plt.savefig('./GSfit/{}cases/k={}/QQPlot_DSM_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)         
       ...
       # 直方图数据
        ...
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Skew normal distribution fit for E(k={}) error: IUFNO'.format(vel_k), fontsize=40, pad=10) 
        plt.xlabel('Error', fontsize=40)  # x 轴标签
        plt.ylabel('Density', fontsize=40)  # y 轴标签
        plt.xticks(fontsize=40)  # x 轴刻度字体大小
        plt.yticks(fontsize=40)  # y 轴刻度字体大小
        ...
        #plt.ylim(0, 9) 
        plt.subplots_adjust(bottom=0.31)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_IUFNO_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_IUFNO_k={}.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
        ...
        for i, (dist_name, dist) in enumerate(distributions.items(), 1):
            ...
            plt.rcParams['mathtext.fontset'] = 'cm'    
            plt.title(fr"QQ Plot of {dist_name} for E(k={vel_k}) error: IUFNO", fontsize=18)
            # 设置刻度字体大小
            plt.xticks(fontsize=21)
            plt.yticks(fontsize=21)
            plt.gca().get_lines()[1].set_linewidth(4)
        ...
        plt.tight_layout()  
        plt.savefig('./GSfit/{}cases/k={}/QQPlot_IUFNO_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
       ...
       # 直方图数据
        ...
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Skew normal distribution fit for E(k={}) error: IFNO'.format(vel_k), fontsize=40, pad=10) 
        plt.xlabel('Error', fontsize=40)  # x 轴标签
        plt.ylabel('Density', fontsize=40)  # y 轴标签
        plt.xticks(fontsize=40)  # x 轴刻度字体大小
        plt.yticks(fontsize=40)  # y 轴刻度字体大小
        ...
        #plt.ylim(0, 10) 
        plt.subplots_adjust(bottom=0.31)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_IFNO_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_IFNO_k={}.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
        ...
        for i, (dist_name, dist) in enumerate(distributions.items(), 1):
            ...
            plt.rcParams['mathtext.fontset'] = 'cm'    
            plt.title(fr"QQ Plot of {dist_name} for E(k={vel_k}) error: IFNO", fontsize=18)
            # 设置刻度字体大小
            plt.xticks(fontsize=21)
            plt.yticks(fontsize=21)
            plt.gca().get_lines()[1].set_linewidth(4)
        ...
        plt.tight_layout()  
        plt.savefig('./GSfit/{}cases/k={}/QQPlot_IFNO_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
    ...
    ####################################################################################################################       
       ...
       # 直方图数据
        ...
        plt.hist(data2, bins=50, density=True,alpha=0.4,color=colors[1], label='Data histogram',zorder=0)
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Normal distribution fit for E(k={}) error: F-IUFNO'.format(vel_k), fontsize=40, pad=10) 
        plt.xlabel('Error', fontsize=40)  # x 轴标签
        plt.ylabel('Density', fontsize=40)  # y 轴标签
        plt.xticks(fontsize=40)  # x 轴刻度字体大小
        plt.yticks(fontsize=40)  # y 轴刻度字体大小
        ...
        plt.grid(False)
        plt.subplots_adjust(bottom=0.31)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_F-IUFNO_gs_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_F-IUFNO_k={}_gs.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
       ...
       # 直方图数据
        ...
        plt.hist(data3, bins=50, density=True,alpha=0.4,color=colors[0], label='Data histogram',zorder=0)
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Normal distribution fit for E(k={}) error: F-IFNO'.format(vel_k), fontsize=40, pad=10) 
        plt.xlabel('Error', fontsize=40)  # x 轴标签
        plt.ylabel('Density', fontsize=40)  # y 轴标签
        plt.xticks(fontsize=40)  # x 轴刻度字体大小
        plt.yticks(fontsize=40)  # y 轴刻度字体大小
        ...
        plt.grid(False)
        plt.subplots_adjust(bottom=0.31)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_F-IFNO_gs_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_F-IFNO_k={}_gs.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
       ...
       # 直方图数据
        ...
        plt.hist(data5, bins=50, density=True,alpha=0.4,color=colors[2], label='Data histogram',zorder=0)
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Normal distribution fit for E(k={}) error: IUFNO'.format(vel_k), fontsize=40, pad=10) 
        plt.xlabel('Error', fontsize=40)  # x 轴标签
        plt.ylabel('Density', fontsize=40)  # y 轴标签
        plt.xticks(fontsize=40)  # x 轴刻度字体大小
        plt.yticks(fontsize=40)  # y 轴刻度字体大小
        ...
        plt.grid(False)
        plt.subplots_adjust(bottom=0.31)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_IUFNO_gs_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_IUFNO_k={}_gs.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
       ...
       # 直方图数据
        ...
        plt.hist(data6, bins=50, density=True,alpha=0.4,color=colors[3], label='Data histogram',zorder=0)
        plt.rcParams['mathtext.fontset'] = 'cm'
        plt.title(r'Normal distribution fit for E(k={}) error: IFNO'.format(vel_k), fontsize=40, pad=10) 
        plt.xlabel('Error', fontsize=40)  # x 轴标签
        plt.ylabel('Density', fontsize=40)  # y 轴标签
        plt.xticks(fontsize=40)  # x 轴刻度字体大小
        plt.yticks(fontsize=40)  # y 轴刻度字体大小
        ...
        plt.grid(False)
        plt.subplots_adjust(bottom=0.31)
        plt.savefig('./GSfit/{}cases/k={}/GSfit_IFNO_gs_k={}.png'.format(case_number,vel_k,vel_k), dpi=300)  
        ...
        result = "拟合结果较好，数据可以认为符合偏态正态分布" if p_value > 0.05 else "拟合结果不理想，可能需要更复杂的分布模型"
        # 保存到 .dat 文件
        output_file = "./GSfit/{}cases/k={}/ks_test_results_IFNO_k={}_gs.dat".format(case_number,vel_k,vel_k)
        with open(output_file, "w") as file:
            file.write("Kolmogorov-Smirnov 检验结果:\n")
            file.write(f"KS Statistic: {ks_stat:.6f}\n")
            file.write(f"P-Value: {p_value:.6f}\n")
