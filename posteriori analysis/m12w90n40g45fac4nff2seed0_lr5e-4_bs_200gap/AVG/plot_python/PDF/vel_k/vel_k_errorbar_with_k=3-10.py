...
for kk, case_number in enumerate(case_number_list):
    ...
    plt.plot(x1[2:], mean1_F_IFNO[2:], color="#1f77b4", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1[2:], mean1_F_IFNO[2:], yerr=std1_F_IFNO[2:], fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend1[0],zorder=3)

    plt.plot(x1[2:], mean1_DSM[2:], color="green", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    plt.errorbar(x1[2:], mean1_DSM[2:], yerr=std1_DSM[2:], fmt='o', color="green", ecolor="green", capsize=8, elinewidth=4, markeredgewidth=4, label=legend1[4],zorder=2)

    plt.plot(x1[2:], mean1_fDSN[2:], color='purple', alpha=0.3, linewidth=3*lineWidth, linestyle='--',zorder=1)
    plt.errorbar(x1[2:], mean1_fDSN[2:], yerr=std1_fDSN[2:], fmt='o', color='purple', ecolor='purple', capsize=8, elinewidth=4, markeredgewidth=4, label=legend1[5],zorder=1)
    ...
    gfile1 = "spectrum errorbar for F-IFNO_k=3-10.png"
    ...
    plt.plot(x1[2:], mean1_F_IUFNO_40ep[2:], color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1[2:], mean1_F_IUFNO_40ep[2:], yerr=std1_F_IUFNO_40ep[2:], fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend1[1],zorder=3)
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar_with_k/{}cases".format(case_number))
    gfile1 = "spectrum errorbar for F-IUFNO_k=3-10.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_extra_artists=(lgd,), bbox_inches='tight')
    plt.close()
    ...
    plt.plot(x1[2:], mean1_IUFNO_40ep[2:], color='gold', alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1[2:], mean1_IUFNO_40ep[2:], yerr=std1_IUFNO_40ep[2:], fmt='o', color='gold', ecolor='gold', capsize=8, elinewidth=4, markeredgewidth=4, label=legend1[2],zorder=3)
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar_with_k/{}cases".format(case_number))
    gfile1 = "spectrum errorbar for IUFNO_k=3-10.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_extra_artists=(lgd,), bbox_inches='tight')
    plt.close()
    ...
    plt.plot(x1[2:], mean1_IFNO[2:], color='pink', alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1[2:], mean1_IFNO[2:], yerr=std1_IFNO[2:], fmt='o', color='pink', ecolor='pink', capsize=8, elinewidth=4, markeredgewidth=4, label=legend1[3],zorder=3)
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar_with_k/{}cases".format(case_number))
    gfile1 = "spectrum errorbar for IFNO_k=3-10.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_extra_artists=(lgd,), bbox_inches='tight')
    plt.close()
