...
std=std1
k=1
plt.plot(x, mean[(k-1)*600:k*600], label=legend[0], color='#A52A2A', linewidth=2*lineWidth, linestyle='solid',zorder=11)
plt.fill_between(x, mean[(k-1)*600:k*600] - std[(k-1)*600:k*600], mean[(k-1)*600:k*600] + std[(k-1)*600:k*600], color='#A52A2A', alpha=0.3,zorder=11)

k=2
plt.plot(x, mean[(k-1)*600:k*600], label=legend[1], color='#ff7f0e', linewidth=lineWidth, linestyle='solid',zorder=11)
plt.fill_between(x, mean[(k-1)*600:k*600] - std[(k-1)*600:k*600], mean[(k-1)*600:k*600] + std[(k-1)*600:k*600], color='#ff7f0e', alpha=0.3,zorder=11)
