...
figPath = os.path.join(figfilePath, "Ek_Errorbar_with_time_30cases_ori_6")
...
step1=1
plt.plot(x, mean1, label=legend[5], color='purple', linewidth=lineWidth, linestyle='solid',zorder=1)
...
##plt.title(r"Mean ± Std error of E(k)", fontsize=30, color='black', loc='center', pad=15)
...
######################### set figure path2 ################################
figfilePath = os.path.abspath('./Errorbar_with_time/')
figPath = os.path.join(figfilePath, "Ek_Errorbar_with_time_30cases_ori_5")
...
######################### set figure path3 ################################
figfilePath = os.path.abspath('./Errorbar_with_time/')
figPath = os.path.join(figfilePath, "Ek_Errorbar_with_time_30cases_ori_2")
...
######################### set figure path3 ################################
figfilePath = os.path.abspath('./Errorbar_with_time/')
figPath = os.path.join(figfilePath, "Ek_Errorbar_with_time_30cases_ori_4")
...
######################### set figure path3 ################################
figfilePath = os.path.abspath('./Errorbar_with_time/')
figPath = os.path.join(figfilePath, "Ek_Errorbar_with_time_30cases_ori_3")
