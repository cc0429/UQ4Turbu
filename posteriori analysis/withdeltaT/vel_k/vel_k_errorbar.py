...
for k, case_number in enumerate(case_number_list):
    ...
    #-------------------------------------------------------------读入数据，
        ...
        plt.plot(x1, mean1_F_IFNO_k, color="#1f77b4", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=4)
        plt.errorbar(x1, mean1_F_IFNO_k, yerr=std1_F_IFNO_k, fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[0],zorder=4)

        plt.plot(x1, mean1_F_IFNO, color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=0)
        plt.errorbar(x1, mean1_F_IFNO, yerr=std1_F_IFNO, fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[4],zorder=0)

        plt.plot(x1, mean1_DSM, color="green", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
        plt.errorbar(x1, mean1_DSM, yerr=std1_DSM, fmt='o', color="green", ecolor="green", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[8],zorder=2)

        plt.plot(x1, mean1_fDNS, color="purple", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=3)
        plt.errorbar(x1, mean1_fDNS, yerr=std1_fDNS, fmt='o', color="purple", ecolor="purple", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[9],zorder=3)
        ...
        gfile1 = "Errorbar for E(k={}) F-IFNO.png".format(vel_k)
        ...
        plt.plot(x1, mean1_F_IUFNO_k, color="#1f77b4", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=4)
        plt.errorbar(x1, mean1_F_IUFNO_k, yerr=std1_F_IUFNO_k, fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[1],zorder=4)

        plt.plot(x1, mean1_F_IUFNO, color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=0)
        plt.errorbar(x1, mean1_F_IUFNO, yerr=std1_F_IUFNO, fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[5],zorder=0)
        ...
        #plt.grid()
        figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k={}".format(case_number,vel_k))
        gfile1 = "Errorbar for E(k={}) F-IUFNO.png".format(vel_k)
        gpath1 = os.path.join(figPath1, gfile1)
        # 保存图形
        plt.savefig(gpath1, bbox_inches='tight')
        plt.close()  
        ...
        plt.plot(x1, mean1_IUFNO_k, color="#1f77b4", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=4)
        plt.errorbar(x1, mean1_IUFNO_k, yerr=std1_IUFNO_k, fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[2],zorder=4)

        plt.plot(x1, mean1_IUFNO, color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=0)
        plt.errorbar(x1, mean1_IUFNO, yerr=std1_IUFNO, fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[6],zorder=0)
        ...
        #plt.grid()
        figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k={}".format(case_number,vel_k))
        gfile1 = "Errorbar for E(k={}) IUFNO.png".format(vel_k)
        gpath1 = os.path.join(figPath1, gfile1)
        # 保存图形
        plt.savefig(gpath1, bbox_inches='tight')
        plt.close()      
        ...
        plt.plot(x1, mean1_IFNO_k, color="#1f77b4", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=4)
        plt.errorbar(x1, mean1_IFNO_k, yerr=std1_IFNO_k, fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[3],zorder=4)

        plt.plot(x1, mean1_IFNO, color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=0)
        plt.errorbar(x1, mean1_IFNO, yerr=std1_IFNO, fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[7],zorder=0)
        ...
        #plt.grid()
        figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k={}".format(case_number,vel_k))
        gfile1 = "Errorbar for E(k={}) IFNO.png".format(vel_k)
        gpath1 = os.path.join(figPath1, gfile1)
        # 保存图形
        plt.savefig(gpath1, bbox_inches='tight')
        plt.close()     
        ...
        plt.plot(x1, mean1_F_IFNO_k, color="#1f77b4", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=3)
        plt.errorbar(x1, mean1_F_IFNO_k, yerr=std1_F_IFNO_k, fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[0],zorder=3)

        plt.plot(x1, mean1_F_IUFNO_k, color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
        plt.errorbar(x1, mean1_F_IUFNO_k, yerr=std1_F_IUFNO_k, fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[1],zorder=2)

        plt.plot(x1, mean1_DSM, color="green", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=0)
        plt.errorbar(x1, mean1_DSM, yerr=std1_DSM, fmt='o', color="green", ecolor="green", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[8],zorder=0)

        plt.plot(x1, mean1_fDNS, color="purple", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=1)
        plt.errorbar(x1, mean1_fDNS, yerr=std1_fDNS, fmt='o', color="purple", ecolor="purple", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[9],zorder=1)
        ...
        #plt.grid()
        figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k={}".format(case_number,vel_k))
        gfile1 = "Errorbar for E(k={}) with4.png".format(vel_k)
        gpath1 = os.path.join(figPath1, gfile1)
        # 保存图形
        plt.savefig(gpath1, bbox_inches='tight')
        plt.close()     
        ...
        plt.plot(x1, mean1_F_IFNO_k, color="#1f77b4", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=5)
        plt.errorbar(x1, mean1_F_IFNO_k, yerr=std1_F_IFNO_k, fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[0],zorder=5)

        plt.plot(x1, mean1_F_IUFNO_k, color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=4)
        plt.errorbar(x1, mean1_F_IUFNO_k, yerr=std1_F_IUFNO_k, fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[1],zorder=4)
        
        plt.plot(x1, mean1_IUFNO_k, color='gold', alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=3)
        plt.errorbar(x1, mean1_IUFNO_k, yerr=std1_IUFNO_k, fmt='o', color='gold', ecolor='gold', capsize=8, elinewidth=4, markeredgewidth=4, label=legend[2],zorder=3)

        plt.plot(x1, mean1_IFNO_k, color='pink', alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
        plt.errorbar(x1, mean1_IFNO_k, yerr=std1_IFNO_k, fmt='o', color='pink', ecolor='pink', capsize=8, elinewidth=4, markeredgewidth=4, label=legend[3],zorder=2)
        ...
        #plt.grid()
        figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k={}".format(case_number,vel_k))
        gfile1 = "Errorbar for E(k={}) with6.png".format(vel_k)
        gpath1 = os.path.join(figPath1, gfile1)
        # 保存图形
        plt.savefig(gpath1, bbox_inches='tight')
        plt.close()      
        ...
        plt.errorbar(x1, mean1_F_IFNO, yerr=std1_F_IFNO, fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[4],zorder=3)

        plt.plot(x1, mean1_F_IUFNO, color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
        plt.errorbar(x1, mean1_F_IUFNO, yerr=std1_F_IUFNO, fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[5],zorder=2)
        ...
        #plt.grid()
        figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k={}".format(case_number,vel_k))
        gfile1 = "Errorbar for E(k={}) without4.png".format(vel_k)
        gpath1 = os.path.join(figPath1, gfile1)
        # 保存图形
        plt.savefig(gpath1, bbox_inches='tight')
        plt.close()     
        ...
        plt.plot(x1, mean1_F_IFNO, color="#1f77b4", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=5)
        plt.errorbar(x1, mean1_F_IFNO, yerr=std1_F_IFNO, fmt='o', color="#1f77b4", ecolor="#1f77b4", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[4],zorder=5)

        plt.plot(x1, mean1_F_IUFNO, color="#ff7f0e", alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=4)
        plt.errorbar(x1, mean1_F_IUFNO, yerr=std1_F_IUFNO, fmt='o', color="#ff7f0e", ecolor="#ff7f0e", capsize=8, elinewidth=4, markeredgewidth=4, label=legend[5],zorder=4)
        
        plt.plot(x1, mean1_IUFNO, color='gold', alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=3)
        plt.errorbar(x1, mean1_IUFNO, yerr=std1_IUFNO, fmt='o', color='gold', ecolor='gold', capsize=8, elinewidth=4, markeredgewidth=4, label=legend[6],zorder=3)

        plt.plot(x1, mean1_IFNO, color='pink', alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
        plt.errorbar(x1, mean1_IFNO, yerr=std1_IFNO, fmt='o', color='pink', ecolor='pink', capsize=8, elinewidth=4, markeredgewidth=4, label=legend[7],zorder=2)
        ...
        #plt.grid()
        figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k={}".format(case_number,vel_k))
        gfile1 = "Errorbar for E(k={}) without6.png".format(vel_k)
        gpath1 = os.path.join(figPath1, gfile1)
        # 保存图形
        plt.savefig(gpath1, bbox_inches='tight')
        plt.close()      
