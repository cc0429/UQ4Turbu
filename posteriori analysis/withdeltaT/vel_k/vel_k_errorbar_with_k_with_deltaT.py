...
for k, case_number in enumerate(case_number_list):
    ...
    ylabel = r"$\mathdefault{{Errorbar \ for \ E(k=1-10)}}$"
    xlimit=[0,0.42]
    #ylimit = [-0.18,0.04]
    ...
    gfile1 = "Errorbar for E(k=1-10) F-IFNO_k.png"
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) F-IUFNO_k.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) IUFNO_k.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) IFNO_k.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) F-IFNO.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) F-IUFNO.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()   
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) IUFNO_label.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) IFNO.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) DSM.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=1-10".format(case_number))
    gfile1 = "Errorbar for E(k=1-10) fDNS.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
