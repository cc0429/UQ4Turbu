...
for k, vel_k in enumerate(vel_k_list):
    ...
    colors=['#1f77b4','#ff7f0e','gold','pink','green','purple']
    ...
    ax.xaxis.set_major_locator(mpl.ticker.MultipleLocator(40)) #次刻度
    ax.xaxis.set_minor_locator(mpl.ticker.MultipleLocator(4))  #次刻度  #主刻度格式
    ...
    mpl.rc('font', family='STIXGeneral')
    # 创建图例
    #plt.title(r"Mean prediction with 95% confidence interval", fontsize=30, color='black', loc='center', pad=15)
    lgd = plt.legend(
        loc='best',
    ...
    figPath1 = os.path.abspath("./Errorbar_with_time/k={}").format(vel_k)
    gfile1 = "F-IFNO with.png"
