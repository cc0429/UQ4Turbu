...
for k, case_number in enumerate(case_number_list):
    ...
    colors = ['#ff0000', '#ff7f00', '#ffaa00', '#ffff00', '#aaff00','#00ff00', '#00ffaa', '#00ffff', '#0000ff', '#8b00ff']
    ...
    yanse=colors[1]
    #plt.plot(x2, mean2, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    yanse=colors[2]
    plt.plot(x3, mean3, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    yanse=colors[3]
    plt.plot(x4, mean4, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    yanse=colors[4]
    plt.plot(x5, mean5, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    yanse=colors[5]
    plt.plot(x6, mean6, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    yanse=colors[6]
    plt.plot(x7, mean7, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    yanse=colors[7]
    plt.plot(x8, mean8, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    yanse=colors[8]
    plt.plot(x9, mean9, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    yanse=colors[9]
    plt.plot(x10, mean10, color=yanse, alpha=0.3, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    # 显示网格
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) F-IFNO_k.png"
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) F-IUFNO_k.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) IUFNO_k.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) IFNO_k.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) F-IFNO.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) F-IUFNO.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()   
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) IUFNO.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) IFNO.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) DSM.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
    ...
    #plt.grid()
    figPath1 = os.path.abspath("./vel_k_errorbar/{}cases/k=3-10".format(case_number))
    gfile1 = "Errorbar for E(k=3-10) fDNS.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()    
