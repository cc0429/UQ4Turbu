...
for k, case_number in enumerate(case_number_list):
    ...
    ACF_data = np.loadtxt("../acf/acf_avg.dat", dtype=float)
    ACF = ACF_data[:6, 1]
    ...
    # 定义颜色列表
    color_palette = ['#A52A2A','#ff7f0e','#ffd700','green','#1f77b4','purple']
    ...
    plt.plot(x1, mean1_F_IFNO_k, color=color_palette[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    plt.errorbar(x1, mean1_F_IFNO_k, yerr=std1_F_IFNO_k, fmt='o', color=color_palette[1], ecolor=color_palette[1], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[0],zorder=4)

    plt.plot(x1, mean1_F_IFNO, color=color_palette[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_F_IFNO, yerr=std1_F_IFNO, fmt='o', color=color_palette[3], ecolor=color_palette[3], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[4],zorder=0)

    plt.plot(x1, mean1_DSM, color=color_palette[4], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    plt.plot(x1, mean1_fDNS, color=color_palette[5], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    ...
    mpl.rc('font', family='STIXGeneral')
    # 创建图例
    #plt.title(r"Errorbar for Ek", fontsize=30, color='black', loc='center', pad=15)
    lgd = plt.legend(
        loc='lower left',
        bbox_to_anchor=(0.1, 0),  # (x, y)，x=1.0是图右边界，y=1.0是图上边界
        fontsize=30,
        frameon=True,
        framealpha=0,
        edgecolor='black',
    ...
    plt.plot(x1, mean1_F_IUFNO_k, color=color_palette[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    ...
    plt.plot(x1, mean1_F_IUFNO, color=color_palette[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_F_IUFNO, yerr=std1_F_IUFNO, fmt='o', color=color_palette[3], ecolor=color_palette[3], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[5],zorder=0)
    ...
    plt.plot(x1, mean1_IUFNO_k, color=color_palette[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    plt.errorbar(x1, mean1_IUFNO_k, yerr=std1_IUFNO_k, fmt='o', color=color_palette[1], ecolor=color_palette[1], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[2],zorder=4)

    plt.plot(x1, mean1_IUFNO, color=color_palette[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_IUFNO, yerr=std1_IUFNO, fmt='o', color=color_palette[3], ecolor=color_palette[3], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[6],zorder=0)
    ...
    lgd = plt.legend(
        loc='upper right',
        bbox_to_anchor=(0.98, 1),  # (x, y)，x=1.0是图右边界，y=1.0是图上边界
        fontsize=30,
        frameon=True,
        framealpha=0,
        edgecolor='black',
    ...
    plt.plot(x1, mean1_IFNO_k, color=color_palette[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    plt.errorbar(x1, mean1_IFNO_k, yerr=std1_IFNO_k, fmt='o', color=color_palette[1], ecolor=color_palette[1], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[3],zorder=4)

    plt.plot(x1, mean1_IFNO, color=color_palette[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    plt.errorbar(x1, mean1_IFNO, yerr=std1_IFNO, fmt='o', color=color_palette[3], ecolor=color_palette[3], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[7],zorder=0)
    ...
    lgd = plt.legend(
        loc='upper right',
        bbox_to_anchor=(0.95, 1),  # (x, y)，x=1.0是图右边界，y=1.0是图上边界
        fontsize=30,
        frameon=True,
        framealpha=0,
        edgecolor='black',
    ...
    plt.plot(x1, mean1_F_IFNO_k, color=color_palette[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1, mean1_F_IFNO_k, yerr=std1_F_IFNO_k, fmt='o', color=color_palette[1], ecolor=color_palette[1], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[0],zorder=3)

    plt.plot(x1, mean1_F_IUFNO_k, color=color_palette[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    plt.errorbar(x1, mean1_F_IUFNO_k, yerr=std1_F_IUFNO_k, fmt='o', color=color_palette[3], ecolor=color_palette[3], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[1],zorder=2)

    plt.plot(x1, mean1_DSM, color=color_palette[4], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=0)
    ...
    plt.plot(x1, mean1_fDNS, color=color_palette[5], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=1)
    ...
    plt.plot(x1, mean1_F_IFNO_k, color=color_palette[0], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=5)
    ...
    plt.plot(x1, mean1_IUFNO_k, color=color_palette[2], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    ...
    plt.plot(x1, mean1_IFNO_k, color=color_palette[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    lgd = plt.legend(
        loc='lower right',
        bbox_to_anchor=(0.85, 0),  # (x, y)，x=1.0是图右边界，y=1.0是图上边界
        fontsize=30,
        frameon=True,
        framealpha=0,
        edgecolor='black',
    ...
    plt.plot(x1, mean1_F_IFNO, color=color_palette[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    plt.errorbar(x1, mean1_F_IFNO, yerr=std1_F_IFNO, fmt='o', color=color_palette[1], ecolor=color_palette[1], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[4],zorder=3)

    plt.plot(x1, mean1_F_IUFNO, color=color_palette[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    plt.errorbar(x1, mean1_F_IUFNO, yerr=std1_F_IUFNO, fmt='o', color=color_palette[3], ecolor=color_palette[3], capsize=8, elinewidth=4, markeredgewidth=4, label=legend[5],zorder=2)
    ...
    plt.plot(x1, mean1_F_IFNO, color=color_palette[0], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=5)
    ...
    plt.plot(x1, mean1_F_IUFNO, color=color_palette[1], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=4)
    ...
    plt.plot(x1, mean1_IUFNO, color=color_palette[2], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=3)
    ...
    plt.plot(x1, mean1_IFNO, color=color_palette[3], alpha=0.8, linewidth=2*lineWidth, linestyle='--',zorder=2)
    ...
    lgd = plt.legend(
        loc='upper right',
        bbox_to_anchor=(0.775, 1),  # (x, y)，x=1.0是图右边界，y=1.0是图上边界
        fontsize=30,
        frameon=True,
        framealpha=0,
        edgecolor='black',
    ...
    plt.ylim(-50, 100)
    figPath1 = os.path.abspath("./Ek_errorbar/{}cases".format(case_number))
    gfile1 = "Errorbar for Ek without6.png"
    gpath1 = os.path.join(figPath1, gfile1)
    # 保存图形
    plt.savefig(gpath1, bbox_inches='tight')
    plt.close()      
